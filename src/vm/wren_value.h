...
//
// Finally, there is one special first-class singleton, called System.notImplemented.
// It is not accessible as a keyword to the user like null, but it is accessible
// through the method System.notImplemented. It is used by binary operators to
// say, "Hey, I don't know the type of my arg!" (same as Python's NotImplemented).
// Its class is NotImplemented.
//
...
#define IS_NOT_IMPLEMENTED(value) ((value) == NOT_IMPLEMENTED_VAL)
...
#define NOT_IMPLEMENTED_VAL ((Value)(uint64_t)(QNAN | TAG_NOT_IMPLEMENTED))
...
#define NOT_IMPLEMENTED_VAL ((Value){ VAL_NOT_IMPLEMENTED, { 0 } })
